...
apt -qy update  2>> update-error.log && apt -qy dist-upgrade  2>> dist-upgrade.log && apt -qy autoremove 2>> autoremove-error.log
...
apt-get -qy install virtualbox-5.2 2>> vb-erro.log
